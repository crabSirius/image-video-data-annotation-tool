...
from label_studio_delivery import DEFAULT_LABEL_STUDIO_UPLOAD_ROOT, build_label_studio_subset


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="从 Label Studio 导出生成可拷贝的已提交样本子集")
